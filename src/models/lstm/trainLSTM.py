...
run:    python -m src.models.lstm.trainLSTM --cache cache/ --epochs 15 --run-dir runs/bilstm_run1
"""
...
def main():
    ...
    config = {
        "arch": "bilstm", "hidden_dim": args.hidden_dim, "num_layers": args.num_layers,
    ...
    run_dir = args.run_dir or trainCommon.make_run_dir("runs", "bilstm", config)
